...
# Function to find similar documents based on embedding
...
def ongoing_conversation(session):
    """
    Start a conversation with GPT-4, using relevant document context from the database.
    """
    print("What would you like to ask Avatar Peter today? Type 'exit', 'quit', or 'bye' to end the conversation.")
    messages = [
        {"role": "system", "content": "You are a helpful assistant. Answer the user's questions based on the relevant context provided from the documents."}
    ]
